            ...
            $(document).on('keyup', '#email', function(e) {
                ...
                if (keynum == 188){
                    ...
                    if (re.test(String(email).toLowerCase())){
                        ...
                        let buildEmailList = '<div id="show-emails" class="modal-body"><ul style="color:'+settings.textColor+'">'+displayList+'</ul></div>'
                        ...
                        let errrMessage = "<div class='email-error' style='margin-left: 3%; margin-right: 3%;border-style: none;'>Please enter a valid email address</div>";
                        if($("#show-emails").length){
